...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|}
        ...
        Memori (server) & $\leq$ 500 MB & 468 MB & \textcolor{green}{OK} \\ \hline
...
Pengujian persentase sukses komunikasi dilaksanakan menggunakan skrip Node.js yang mengirimkan permintaan baca (\textit{read request}) berulang ke alamat memori \texttt{D100} pada PLC. Parameter utama pengujian adalah sebagai berikut:
\begin{itemize}
...
\begin{itemize}
\item Dari 10 kegagalan, mayoritas tercatat sebagai \textbf{timeout} (tidak ada respons dalam jangka waktu tunggu skrip). Timeout ini terekam juga pada Wireshark sebagai paket request tanpa paket reply yang sesuai.
...
\item Faktor penyebab kegagalan yang mungkin: kerugian paket UDP di jaringan fisik/layer link, sementara PLC sedang sibuk memproses permintaan lain (antrian internal), atau packet scheduling pada host yang mengirim request terlalu agresif untuk kondisi jaringan uji.
\end{itemize}
