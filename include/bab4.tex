...
\begin{figure}[H]
    ...
    \caption{Demo sistem HMI saat berjalan dan berkomunikasi langsung dengan PLC secara \textit{realtime}. Antarmuka menampilkan visualisasi data berupa grafik (\textit{chart}) dan kontrol input berupa \textit{slider} yang responsif terhadap nilai aktual di PLC.}
    \label{fig:demo-run}
\end{figure}
