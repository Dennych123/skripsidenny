...
Host Client & PC (Intel core i7 11th gen, 16GB RAM, Windows 11) \\ \hline
IP PLC & 192.168.0.1 \\ \hline
IP PC & 192.168.0.234 \\ \hline
...
\begin{itemize}
    ...
    \item \textbf{PC:} Bertindak sebagai server HMI (menjalankan Node.js dan FUXA).
    \item \textbf{Tablet:} Digunakan untuk mengakses HMI melalui browser dengan alamat IP server di jaringan Wi-Fi yang sama.
    \item \textbf{Hub/Switch:} Menghubungkan PLC dan PC secara fisik melalui kabel LAN.
\end{itemize}
...
PC (Server HMI) & 192.168.11.234 \\ \hline
